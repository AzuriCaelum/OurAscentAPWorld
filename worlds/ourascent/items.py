...
item_table: Dict[str, ItemData] = {
    ...
    "Equipment - Hina Progressive Right Weapon": ItemData("EQUIPMENT", 13 + equipment_offset, ItemClassification.progression, 0, 0, 13),
    ...
    "Equipment - Hina Progressive Cloak": ItemData("EQUIPMENT", 17 + equipment_offset, ItemClassification.progression, 0, 0, 10),
    "Equipment - Hina Progressive Left Weapon": ItemData("EQUIPMENT", 18 + equipment_offset,ItemClassification.progression, 0, 0, 13),
    ...
    "Equipment - Lan Progressive Belt": ItemData("EQUIPMENT", 22 + equipment_offset, ItemClassification.progression, 0, 0, 0, 9),
    ...
    #Glades
    "Augment - Apolonia Weapon Mastery": ItemData("AUGMENT", 1 + augment_offset, ItemClassification.progression, 5),
    "Augment - Apolonia Magical Imbuement": ItemData("AUGMENT", 2 + augment_offset, ItemClassification.progression, 4),
    "Augment - Apolonia Mobility": ItemData("AUGMENT", 3 + augment_offset, ItemClassification.progression, 6),
    "Augment - Apolonia Holy Power": ItemData("AUGMENT", 4 + augment_offset, ItemClassification.progression, 3),
    "Augment - Stan Vitality Boost": ItemData("AUGMENT", 5 + augment_offset, ItemClassification.progression, 0, 3),
    "Augment - Stan Amplified Strength": ItemData("AUGMENT", 6 + augment_offset, ItemClassification.progression, 0, 3),
    "Augment - Stan Swift Steps": ItemData("AUGMENT", 7 + augment_offset, ItemClassification.progression, 0, 3),
    "Augment - Stan Defiant Guard": ItemData("AUGMENT", 8 + augment_offset, ItemClassification.progression, 0, 3),
	"Augment - Stan Fierce Onslaught": ItemData("AUGMENT", 9 + augment_offset, ItemClassification.progression, 0, 5),
    "Augment - Hina Mighty Monkey": ItemData("AUGMENT", 10 + augment_offset, ItemClassification.progression, 0, 0, 5),
    "Augment - Hina Sinister Serpent": ItemData("AUGMENT", 11 + augment_offset, ItemClassification.progression, 0, 0, 5),
    "Augment - Hina Tenacious Tiger": ItemData("AUGMENT", 12 + augment_offset, ItemClassification.progression, 0, 0, 5),
    "Augment - Hina Patient Panda": ItemData("AUGMENT", 13 + augment_offset, ItemClassification.progression, 0, 0, 5),
	"Augment - Hina Punch Training": ItemData("AUGMENT", 14 + augment_offset, ItemClassification.progression, 0, 0, 3),
	"Augment - Hina Form Training": ItemData("AUGMENT", 15 + augment_offset, ItemClassification.progression, 0, 0, 3),
	"Augment - Hina Speed Training": ItemData("AUGMENT", 16 + augment_offset, ItemClassification.progression, 0, 0, 3),
	"Augment - Hina Kick Training": ItemData("AUGMENT", 17 + augment_offset, ItemClassification.progression, 0, 0, 3),
    "Augment - Lan Lucky Shots": ItemData("AUGMENT", 18 + augment_offset, ItemClassification.progression, 0, 0, 0, 5),
    "Augment - Lan Relentless Fire": ItemData("AUGMENT", 19 + augment_offset, ItemClassification.progression, 0, 0, 0, 4),
    "Augment - Lan Hunter's Insight": ItemData("AUGMENT", 20 + augment_offset, ItemClassification.progression, 0, 0, 0, 2),
    "Augment - Lan Bloodthirsty Quiver": ItemData("AUGMENT", 21 + augment_offset, ItemClassification.progression, 0, 0, 0, 3),
	"Augment - Lan Killer Instinct": ItemData("AUGMENT", 22 + augment_offset, ItemClassification.progression, 0, 0, 0, 1),
    "Augment - Sibyl Silent Steps": ItemData("AUGMENT", 23 + augment_offset, ItemClassification.progression, 0, 0, 0, 0, 6),
    "Augment - Sibyl Dual Depredation": ItemData("AUGMENT", 24 + augment_offset, ItemClassification.progression, 0, 0, 0, 0, 4),
    "Augment - Sibyl Grounded Motion": ItemData("AUGMENT", 25 + augment_offset, ItemClassification.progression, 0, 0, 0, 0, 3),
    "Augment - Sibyl Stunning Distraction": ItemData("AUGMENT", 26 + augment_offset, ItemClassification.progression, 0, 0, 0, 0, 2),
	"Augment - Sibyl Ruinous Bleed": ItemData("AUGMENT", 27 + augment_offset, ItemClassification.progression, 0, 0, 0, 0, 7),
